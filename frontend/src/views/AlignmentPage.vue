...
.input-card .pulley-table-wrapper {
  flex: 1;
}
...
.pulley-table th:nth-child(1),
.pulley-table td:nth-child(1) {
  min-width: 60px;
}

.pulley-table th:nth-child(2),
.pulley-table td:nth-child(2) {
  min-width: 80px;
}

.pulley-table th:nth-child(3),
.pulley-table td:nth-child(3) {
  min-width: 100px;
}
...
.grid-row .result-card :deep(.el-card__body) {
  flex: 1;
  display: flex;
  flex-direction: column;
}

.grid-row .result-card .result-table-wrapper {
  flex: 1;
}
